...
public class ProstyKalkulatorObjetosciBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_kolorKomponentu = 37;
    private static final int PROPERTY_kolorWypelnieniaKomponentu = 38;
    ...
    private static final int PROPERTY_solidHeight = 60;
    private static final int PROPERTY_solidRadius = 61;
    ...
    private static final int PROPERTY_wielkoscKomponentu = 67;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getAlignmentX", null ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getAlignmentY", null ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isDoubleBuffered", null ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, null, null, "getFocusTraversalKeys", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_kolorKomponentu] = new PropertyDescriptor ( "kolorKomponentu", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getKolorKomponentu", "setKolorKomponentu" ); // NOI18N
            properties[PROPERTY_kolorWypelnieniaKomponentu] = new PropertyDescriptor ( "kolorWypelnieniaKomponentu", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getKolorWypelnieniaKomponentu", "setKolorWypelnieniaKomponentu" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isOpaque", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_solidHeight] = new PropertyDescriptor ( "solidHeight", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getSolidHeight", "setSolidHeight" ); // NOI18N
            properties[PROPERTY_solidRadius] = new PropertyDescriptor ( "solidRadius", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getSolidRadius", "setSolidRadius" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isValid", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_wielkoscKomponentu] = new PropertyDescriptor ( "wielkoscKomponentu", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getWielkoscKomponentu", "setWielkoscKomponentu" ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( KalkulatorObjetosci.ProstyKalkulatorObjetosci.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_calcConeVolume7] = new MethodDescriptor(KalkulatorObjetosci.ProstyKalkulatorObjetosci.class.getMethod("calcConeVolume", new Class[] {})); // NOI18N
            methods[METHOD_calcConeVolume7].setDisplayName ( "" );
            methods[METHOD_calcCylinderVolume8] = new MethodDescriptor(KalkulatorObjetosci.ProstyKalkulatorObjetosci.class.getMethod("calcCylinderVolume", new Class[] {})); // NOI18N
            methods[METHOD_calcCylinderVolume8].setDisplayName ( "" );
            methods[METHOD_calcSphereVolume9] = new MethodDescriptor(KalkulatorObjetosci.ProstyKalkulatorObjetosci.class.getMethod("calcSphereVolume", new Class[] {})); // NOI18N
            ...
            methods[METHOD_paint68] = new MethodDescriptor(KalkulatorObjetosci.ProstyKalkulatorObjetosci.class.getMethod("paint", new Class[] {java.awt.Graphics.class})); // NOI18N
